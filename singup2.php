...
if(isset($_POST['register'])) //check button name "register" and set this
{
 ...
 // move_uploaded_file($_FILES["uploadfile"]["tmp_name"],"Certificate/".$_FILES["uploadfile"]["name"]);
######################################
 ...
 if(empty($username)){      
  ...
  $errorMsg="please select your profile"; //check username textbox not empty or null
   ...
   else
   {
      ...
      if( $profile != 1 && isset($_FILES['Certificate'])){
        ...
        $error = $_FILES['Certificate']['error'];
            ...
            $img_ex_lc = strtolower($img_ex);
              ...
              $insert_stmt="INSERT INTO login(username,name,gender,phone,address,email,password,profile,image) VALUES('$username','$name','$gender','$phone','$address','$email','$password','$profile','$new_img_name')"; //sql insert query  
    ...
    header("refresh:2;loginpage.php"); //refresh 4 second and redirect to index.php page
   }
  }
...
<input type="radio" value="Other" name="gender"> Other  </b>
 ...
 <label class="col-sm-3 control-label"><b>Phone</b></label>
  <div class="col-sm-6">  
<input type="tel" name="phone" pattern="\+?\d{0,3}[\s\(\-]?([0-9]{2,3})[\s\)\-]?([\s\-]?)([0-9]{3})[\s\-]?([0-9]{2})[\s\-]?([0-9]{2})" placeholder="phone no." size="10"/ class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" required="">   
</div>
</div>
 ...
 <label class="col-sm-3 control-label"><b>Address</b></label>
  <div class="col-sm-6">
<textarea cols="50" rows="5" placeholder="Current Address" value="address" name="address" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" required="">  
</textarea>  
</div>
</div>
 ...
 <label class="col-sm-3 control-label"><b>Email</b></label>
  <div class="col-sm-6">
 <input type="email" placeholder="Enter Email" name="email" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" required="">  
 </div>
 </div>
 ...
 <label class="col-sm-3 control-label"for="psw-repeat"><b>Re-type Password</b> </label>
  <div class="col-sm-6">
    <input type="password" placeholder="Retype Password" name="password2" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white" required="">  
	</div>
	</div>
 ...
 <label class="col-sm-3 control-label"><b>Profile</b></label>
  <div class="col-sm-6">
<select id='Profile'name="profile" onchange="showMe(this);" class="u-border-2 u-border-black u-border-no-left u-border-no-right u-border-no-top u-input u-input-rectangle u-white">  
...
<div class="u-form-agree u-form-group u-form-group-6">
	...
	<!-- <div class="u-align-left u-form-group u-form-submit">
                        <a href="#" class="u-active-palette-1-light-2 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-12 u-btn-1">Register</a> 
                          <input type="submit" value="register" name="register" class="u-form-control-hidden"> 
 ...
 <input type="submit"  name="register" class="u-active-palette-1-light-2 u-border-none u-btn u-btn-round u-btn-submit u-button-style u-hover-palette-1-light-1 u-palette-1-base u-radius-12 u-btn-1 " value="Register">
 </div>
 </div>  
