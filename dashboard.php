		...
		<main>
			...
			<ul class="box-info" >
			  ...
			  ?>
					...
					<span class="text">Total Users <br> <p><?php echo $count_total;?></p>
					</span>
				</li>
				<li>
					<i class='bx bxs-calendar-check' ></i>
					<span class="text">Total Customers<br> <p><?php echo $count_cust;?></p>
					</span>
				</li>
				
				<li>
					<i class='bx bxs-group' ></i>
					<span class="text">Total Architects <br> <p><?php echo $count_arc;?></p>
					</span>
				</li>
				<li>
					<i class='bx bxs-dollar-circle' ></i>
					<span class="text">Contractor <br> <p><?php echo $count_cont;?></p>
					</span>
				</li> 
